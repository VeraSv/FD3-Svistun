...
var Shop = React.createClass({
    ...
    render: function(){
       var good=this.state.goods.map(i=>
        ...
        React.createElement(Goods, {key:i.name,id:i.name,  deleteGood:this.deleteGood, selectedGood:this.state.selectedGood, select:this.select,name:i.name,  price:i.price, count:i.count, url:i.url})
