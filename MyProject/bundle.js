    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          { to: "/page/" + 'A', className: 'MobileClientFIO' },
          'A'
        ),
        _react2.default.createElement(
          _reactRouterDom.NavLink,
          { to: "/page/" + 'Б', className: 'MobileClientFIO' },
          'Б'
        ),
        _react2.default.createElement(
          _reactRouterDom.NavLink,
          { to: "/page/" + 'В', className: 'MobileClientFIO' },
          'В'
        )
      );
    }
...
var _PagesLinks = __webpack_require__(81);
...
var _PageInfo = __webpack_require__(77);
...
var _Page_List = __webpack_require__(79);
  ...
  _createClass(PagesRouter, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_reactRouterDom.Route, { path: '/', exact: true, component: _Main_Page2.default }),
        _react2.default.createElement(_reactRouterDom.Route, { path: '/list', component: _Page_List2.default }),
        _react2.default.createElement(_reactRouterDom.Route, { path: '/list/:page', component: _PageInfo2.default })
      );
    }
  }]);
...
var PageInfo = function (_React$PureComponent) {
    _inherits(PageInfo, _React$PureComponent);
...
var Main_Page = function (_React$PureComponent) {
  _inherits(Main_Page, _React$PureComponent);

  function Main_Page() {
    _classCallCheck(this, Main_Page);

    return _possibleConstructorReturn(this, (Main_Page.__proto__ || Object.getPrototypeOf(Main_Page)).apply(this, arguments));
  }

  _createClass(Main_Page, [{
    key: 'render',
    value: function render() {
...
var _Encyclopedia = __webpack_require__(80);
...
var Page_List = function (_React$PureComponent) {
  _inherits(Page_List, _React$PureComponent);
  ...
  function Page_List() {
    ...
    _classCallCheck(this, Page_List);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Page_List.__proto__ || Object.getPrototypeOf(Page_List)).call.apply(_ref, [this].concat(args))), _this), _this.loadData = function () {
  ...
  _createClass(Page_List, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(_Encyclopedia2.default, {
        info: this.info
      });
    }
  }]);
...
var Encyclopedia = function (_React$PureComponent) {
    _inherits(Encyclopedia, _React$PureComponent);
    ...
    function Encyclopedia() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Encyclopedia.__proto__ || Object.getPrototypeOf(Encyclopedia)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            list: [],
            listA: [],
            listB: [],
            listV: []
        ...
        }, _this.restoreInfo = function () {
            $.ajax({
                url: 'https://fe.it-academy.by/AjaxStringStorage2.php', type: 'POST', cache: false, dataType: 'json',
                data: { f: 'READ', n: 'Svistun_Test' },
                success: _this.readReady, error: _this.errorHandler
            });
        }, _this.readReady = function (callresult) {
  ...
  _createClass(PagesLinks, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          _reactRouterDom.NavLink,
          { to: '/list', className: 'PageLink', activeClassName: 'ActivePageLink' },
          '\u041E\u0433\u043B\u0430\u0432\u043B\u0435\u043D\u0438\u0435'
        )
      );
    }
