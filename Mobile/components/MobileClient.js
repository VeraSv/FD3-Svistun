...
client: PropTypes.object
  ...
  edit=(EO)=>{
    events.emit('EditClicked',this.props.client.name);
  }

  delete=(EO)=>{
    events.emit('DeleteClicked',this.props.client.name);
  }
  render() {
    console.log("MobileClient id="+this.props.client.name+" render");
    return (
